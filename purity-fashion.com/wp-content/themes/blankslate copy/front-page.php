...
<div class="plinks animateme" data-when="view" data-from="1" data-to="0" data-translatex="0" data-opacity="0.5" data-translatey="-1100"><a class="dot" href="http://purity-fashion.com/komanda">КОМАНДА</a><a class="dot" href="http://purity-fashion.com/history">ИСТОРИЯ</a></div>
...
<a href="http://purity-fashion.com/stylist/">Персональный стилист</a>
		...
		<li><a href="http://purity-fashion.com/atele-masterskaya/">Мастерская-ателье</a>
...
<div class="ableft animateme" data-when="exit" data-from="0.2" data-to="0" data-opacity="0" style="opacity: 1; transform: translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale3d(1, 1, 1); easing: easein;"><h2><?php the_title(); ?></h2>   
<?php the_content(); ?>  </div>
...
<section class="lookbook">
	...
	<ul class="sq" id="back-top">
		<li class="portf"><a href="http://purity-fashion.com/category/portfolio/">Портфолио</a>
		</li>
