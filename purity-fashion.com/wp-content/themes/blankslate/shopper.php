<?php
/*
Template Name: Персональный шопинг
*/
?>
<?php get_header(); ?>
...
<div class="crow scrollme">
	...
	<div class="conceptinfo animateme"  data-when="view" data-from="0.8" data-to="0" data-opacity="0" data-translatex="0" data-translatey="500">
			...
			<span><?php the_field('tt-1'); ?></span><span class="pric"><?php the_field('pt-1'); ?></span>
</div>
</div>
<div class="crow scrollme">
...
<div class="crowbot scrollme hide">
