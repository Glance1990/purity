...
<li data-filter="gridall" class="gridactive"><?php esc_attr_e( 'All', 'dvgallery') ?></li>
<?php 
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        imagesLoaded('#dvgrid<?php echo esc_js($random); ?>', function () {
            ...
            setTimeout(function(){
                ...
                jQuery('#dvgrid<?php echo esc_js($random); ?>').find('li').addClass('dvgrid-animate');
            }, 500);
        });
    ...
    jQuery(window).on('resize orientationchange', function () {
        "use strict";
        jQuery('#dvgrid<?php echo esc_js($random); ?>').find('li').removeClass('dvgrid-animate');
    });
</script>
