...
<ul id="dvgrid<?php echo esc_attr($random); ?>" class="dvgrid">
    ...
    <li>
    <div id="dvsquarebox<?php echo esc_attr($looprandom); ?><?php $galleryid; ?>" class="dvsquare">
...
$thumb_url = $thumb_url_array[0];  
        ?>
        <a href="<?php if ($gallerytype == 'link') { echo esc_url($externallink); } else {echo esc_attr('#');} ?>" class="<?php if ($gallerytype != 'link') { echo esc_attr('openlightbox'); } ?> <?php if ($gallerytype == 'video') { echo esc_attr('videogal'); } ?> <?php if ($gallerytype == 'link') { echo esc_attr('linkgal'); } ?>" <?php if ($newindow == 'on') { echo 'target="_blank"'; } ?>>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery('#dvsquarebox<?php echo esc_js($looprandom); ?><?php $galleryid; ?> .openlightbox').click(function (e) {
            e.preventDefault();
