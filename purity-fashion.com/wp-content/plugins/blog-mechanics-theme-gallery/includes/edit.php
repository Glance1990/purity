	...
	if(!function_exists('twoJGalleryJSDialog')){
		function twoJGalleryJSDialog(){
			...
			echo '<div id="twoj_gallery_dialog_options" '
						...
						.'data-title="'.__('2J Gallery Premium', 'blog-mechanics-theme-gallery').'" '
					...
					.'>'
					.__('Get full freedom and much more functionality with 2J Gallery Premium version ', 'blog-mechanics-theme-gallery')
				.'</div>';
