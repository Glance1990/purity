...
class MGWCZ {
    ...
    ?>
    <div class="uwcz-message error notice is-dismissible" style="display:none;">
        ...
        <a class="button-primary" style="margin-bottom: 10px;" href="http://codecanyon.net/item/ultimate-woocommerce-cloudzoom-for-product-images/12148208/?ref=dedalx" target="_blank">Update to PRO version to get premium features and disable ads</a>
