    ...
    function CheckLicense(node) {
        ...
        function click(e) {
            ...
            function checkKey(str) {
                var s = $.trim(str);
                if ('' === s) { return false; } else { return str; }
            }
            ...
            $.post(magictoolbox_WordPress_MagicZoom_admin_modal_object.ajax, {
                action: "magictoolbox_WordPress_MagicZoom_set_license",
                nonce: magictoolbox_WordPress_MagicZoom_admin_modal_object.nonce,
                key: license,
