<?php
    ...
    $plugin_version = plugin_get_version_WordPress_MagicZoom();
    $isKey = magictoolbox_WordPress_MagicZoom_get_data_from_db();
    $isScrollKey = false;
    $isScrollKey = magictoolbox_WordPress_MagicZoom_get_data_from_db('WordPress_MagicZoom_magicscroll');
?>
<div class="license-container">
    ...
    <div class="magictoolbox-trial-box update-nag" style="width: 300px;    float: right;    display: inline-block;    margin-right: 45px; padding: 20px;">
        ...
        To remove the message, please <a target="_blank" href="<?php echo WordPressMagicZoom_url('https://www.magictoolbox.com/buy/magiczoom/','license page trial badge buy link'); ?>">buy a license</a>.
        </br></br>
    ...
    <div class="magictoolbox-trial-text">
        ...
        <p><a href="<?php echo WordPressMagicZoom_url('https://www.magictoolbox.com/buy/magiczoom/','license page buy your license link'); ?>" target="_blank" class="button button-primary orange-button">Buy my Magic Zoom license &gt;</a></p>
        <p>
            ...
            <div style="position: relative; display: inline-block; vertical-alight: middle;">
                ...
                <div class="msg-wrapper">
                    ...
                    <div class="problem sad-message">
                        There was a problem with checking your license key. Please <a target="_blank" href="<?php echo WordPressMagicZoom_url('https://www.magictoolbox.com/contact/','license page problem contact link'); ?>">contact us</a>
                    </div>
                </div>
            </div>
        </div>
