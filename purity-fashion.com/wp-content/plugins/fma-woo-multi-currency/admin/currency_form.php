...
<div class="wrap">
	...
	<?php if(!isset($_GET['add']) && $_GET['add']!= 1){ ?>
		...
		<p class="search-box">
			...
			<input type="search" id="user-search-input" name="s" value="<?php echo $_REQUEST['s']; ?>">
					...
					<tbody>
						...
						<tr valign="top">
							...
							<td>
								...
								<p class="submit"><input type="button" onclick="vForm()" name="" id="" class="button button-primary button-large" value="<?php echo $btn?$btn:'Add Currency'; ?> <?php echo $title?>"></p>	
							</td>
