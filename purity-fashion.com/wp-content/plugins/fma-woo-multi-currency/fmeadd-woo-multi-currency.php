...
session_start();
/*
 * Plugin Name:       FMA Multi Currency
 * Plugin URI:        http://fmeaddons.com/wordpress/fmeaddon-woo-multi-currency
 * Description:       FMA multi currency module is use to add multi currency feature in woocommerce.
 * Version:           1.0
 * Author:            FME Addons
