...
pp_images[b]+'"]:not(.jig-hiddenLink) img').eq(0).attr("src"),"undefined"==typeof img_src&&(img_src=pp_images[b])):img_src=pp_images[b]):(classname=' class="default"',img_src=""),toInject+="<li"+classname+'><a href="#"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" style="background-image: url('+img_src+');" alt="'+encodeURIComponent(g(pp_titles[b].replace(/<a(?:.+?)href=['"](.+?)['"](?:.+?>)(.+?)(?:<\/a>)/mg,"$2: $1")))+'" /></a></li>';toInject=settings.gallery_markup.replace(/{gallery}/g,
