...
class gg_builder_hub {
	...
	public function spec_opt($params = false) {
		...
		if($this->src != 'wp') {
			...
			if($this->src == 'dropbox') {
				$code .= '<div style="padding: 8px 12px; border: 1px solid #fcc1c1; background-color: #ffefef; border-left-width: 8px;">Starting from <strong>September 2017</strong> Dropbox <a href="https://www.dropbox.com/help/16" target="_blank">will end public folder service</a>. Then <strong>won\'t be possible</strong> to fetch images from this source</div>';	
			}
			///////////////////////////////////
